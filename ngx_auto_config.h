#define NGX_CONFIGURE " --with-cc=gcc --with-cc-opt=-O0 --with-debug --prefix= --conf-path=conf/nginx.conf --pid-path=logs/nginx.pid --http-log-path=logs/access.log --error-log-path=logs/error.log --sbin-path=nginx.exe --http-client-body-temp-path=temp/client_body_temp --http-proxy-temp-path=temp/proxy_temp --http-fastcgi-temp-path=temp/fastcgi_temp --http-scgi-temp-path=temp/scgi_temp --http-uwsgi-temp-path=temp/uwsgi_temp --without-http_rewrite_module --without-http_gzip_module --without-http_geo_module --with-http_realip_module --with-http_stub_status_module --with-select_module --with-http_dav_module"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 10.3.0 (tdm64-1) "
#endif
